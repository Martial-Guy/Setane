...
export class ApiService {
  ...
  categories = [      
    { id: 1, name: 'Cameroonian', image: 'assets/dishes/ndole.jpg' } ,
    { id: 2, name: 'North Indian', image: 'assets/dishes/nan.jpg' },
    { id: 3, name: 'Italian', image: 'assets/dishes/pasta.jpg' },
    { id: 4, name: 'Chowmein', image: 'assets/dishes/chowmein.jpg' },
    { id: 5, name: 'South Indian', image: 'assets/dishes/dosa.jpg' },
    { id: 6, name: 'Mexican', image: 'assets/dishes/dol.jpg' },
  ];
  ...
  favorites = [
    {
      id:'1',
      cover:'assets/dishes/souchi.jpg',
      name:'Souchi',
      cuisines:[
            'Japonais',
            'Chine',
    ...
    {
      id: '2',
      cover: 'assets/dishes/ndole2.jpg',
      name: 'Ndole',
      cuisines: [
        'Camerronian',
      ],
  ...
  nearby = [
    ...
    {
      id: '2',
      cover: 'assets/dishes/mediterranean-all-purose-bead.jpg',
      name: 'Mediterranean All Purose-Bead',
      cuisines: [
        'Italian',
        'Mexican',
        'Chinese'
